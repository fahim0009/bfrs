  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.governance')}}" id="governence"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Governence</span></a></li>
        @endif

        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.researcher')}}" id="researcher"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Researcher</span></a></li>
        @endif

        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.client')}}" id="client"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Partners</span></a></li>
        @endif
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.publication')}}" id="publication"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Publication</span></a></li>
        @endif
        ...
        <li class="treeview" id="allservice"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Featured Programs</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{ route('admin.service')}}" id="service"><i class="icon fa fa-circle-o"></i> Add Programs</a></li>
          </ul>
        </li>
        ...
        <li class="treeview" id="allblog"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Recent Event</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            {{-- <li><a class="treeview-item" href="{{ route('admin.blog_category')}}" id="blogcategory"><i class="icon fa fa-circle-o"></i>Add Category</a></li> --}}
            <li><a class="treeview-item" href="{{ route('admin.blog')}}" id="blog"><i class="icon fa fa-circle-o"></i> Add Event</a></li>
          </ul>
        </li>
