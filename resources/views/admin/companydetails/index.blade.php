                ...
                <div class="col-lg-6">
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" id="phone3" name="phone3" value="@if (!empty($company->phone3)){{$company->phone3}}@endif" type="number">
                    </div>
                    <div class="form-group">
                      <label for="phone4">Phone 4</label>
                      <input class="form-control" id="phone4" name="phone4" value="@if (!empty($company->phone4)){{$company->phone4}}@endif" type="number">
                    </div>
                ...
                <div class="col-lg-4 offset-lg-1">
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="youtube" value="@if (!empty($company->youtube)){{$company->youtube}}@endif" name="youtube" class="form-control">
                  </div>
