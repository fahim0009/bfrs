                                    ...
                                    <table class="table table-bordered table-hover" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td style="text-align: center">{{$data->facebook}}</td>
                                              <td style="text-align: center">{{$data->twitter}}</td>
                                              <td style="text-align: center">{{$data->youtube}}</td>
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            //
            var url = "{{URL::to('/admin/governance')}}";
            // console.log(url);
